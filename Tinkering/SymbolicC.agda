...
g ∘ f = swiz₂ ∘ᶜ secondᶜ g ∘ᶜ swiz₁ ∘ᶜ firstᶜ f ∘ᶜ assocˡᶜ
 where
...
f ⊗ g = transposeᶜ ∘ᶜ (f ⊗ᶜ g) ∘ᶜ transposeᶜ

infixr 7 _▵_
_▵_ : {f : A ◇.⇨ C} {g : A ◇.⇨ D} → Mealy f → Mealy g → Mealy (f ◇.▵ g)
f ▵ g = (f ⊗ g) ∘ comb dupᶜ

-- _start_818 : ◇._⇨_.State f₁
-- _start_821 : ◇._⇨_.State g₁
-- _start_824 : Σ (◇._⇨_.State f₁) (λ v → ◇._⇨_.State g₁)

-- Oh! the recordless definition of Mealy loses the start state.
-- Why do _∘_ and _⊗_ type-check?
